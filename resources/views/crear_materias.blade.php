...
<head>
    ...
    <title>Crear Materia - Sistema Académico</title>
    ...
    <style>
        ...
        * {
        ...
        /* Estilo especial para input number */
        input[type="number"] {
...
<div class="card-container">
    <div class="card-main">
        <div class="card-header-custom">
            <i class="fas fa-book-open icon-header"></i>
        ...
        <form action="/materias/guardar" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       required>
                <div class="form-text">
                    <i class="fas fa-info-circle"></i> Ingresa el nombre completo de la materia
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number"
                       ...
                       required>
                <div class="form-text">
                    <i class="fas fa-info-circle"></i> Número de créditos (1-10)
                </div>
            </div>
