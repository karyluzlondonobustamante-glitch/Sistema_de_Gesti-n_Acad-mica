...
<head>
    ...
    <title>Editar Profesor - Sistema Académico</title>
    ...
    <style>
        /* Mismos estilos que editar estudiante */
        :root {
            --color-fondo: #F5F0E8;
            --color-cajas: #FDFBF7;
            --color-bordes: #D4A574;
...
<div class="card-container">
    <div class="card-main">
        ...
        <div class="alert-info">
            ...
            <span>Estás editando al profesor <strong>#{{ $profesor->id }}</strong></span>
        </div>

        <form action="/profesores/actualizar/{{ $profesor->id }}" method="POST">
