...
<div class="container-main">
    ...
    <div class="content-section">
        <div class="content-header">
            <h2>
                <i class="fas fa-users" style="color: var(--color-botones);"></i>
                Listado de Estudiantes
                <span class="badge-count">{{ $estudiantes->count() }}</span>
            </h2>
            <a href="/estudiantes/crear" class="btn-add">
                <i class="fas fa-plus-circle"></i> Añadir Nuevo Estudiante
            </a>
        </div>
            ...
            <table class="table-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><i class="fas fa-envelope" style="color: var(--color-bordes);"></i> {{ $estudiante->correo }}</td>
                        <td><i class="fas fa-graduation-cap" style="color: var(--color-botones);"></i> {{ $estudiante->programa }}</td>
                        <td>
                            <div class="actions">
                                <a href="/estudiantes/editar/{{ $estudiante->id }}" class="btn-edit">
                                    <i class="fas fa-edit"></i> Editar
                                </a>
                                <form action="/estudiantes/eliminar" method="POST" style="display:inline;" onsubmit="return confirm('¿Seguro que deseas eliminar a este estudiante?')">
        ...
        <div class="text-center py-5" style="color: var(--color-texto); opacity: 0.6;">
            ...
            <a href="/estudiantes/crear" class="btn-add" style="display: inline-flex; margin-top: 10px;">
