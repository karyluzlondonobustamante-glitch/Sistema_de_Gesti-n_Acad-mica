...
<head>
    ...
    <title>Editar Materia - Sistema Académico</title>
    ...
    <style>
        /* Mismos estilos que las otras vistas de edición */
        :root {
            --color-fondo: #F5F0E8;
            --color-cajas: #FDFBF7;
            --color-bordes: #D4A574;
...
<div class="card-container">
    <div class="card-main">
        <div class="card-header-custom">
            <i class="fas fa-book-edit icon-header"></i>
        ...
        <div class="alert-info">
            ...
            <span>Estás editando la materia <strong>#{{ $materia->id }}</strong></span>
        </div>

        <form action="/materias/actualizar/{{ $materia->id }}" method="POST">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            @method('PUT')

            <div class="form-group">
                <label for="nombre_materia" class="form-label">
                    <i class="fas fa-book"></i> Nombre de la Materia <span class="required">*</span>
                </label>
                <input type="text"
                       class="form-control"
                       name="nombre_materia"
            ...
            <div class="form-group">
                <label for="creditos" class="form-label">
                    <i class="fas fa-star"></i> Créditos <span class="required">*</span>
                </label>
                <input type="number"
                       class="form-control"
                       name="creditos"
            ...
            <div class="btn-actions">
                ...
                <a href="/materias" class="btn-secondary-custom">
