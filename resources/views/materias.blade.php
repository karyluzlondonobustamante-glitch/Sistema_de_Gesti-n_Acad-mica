...
<head>
    ...
    <title>Materias - Sistema Académico</title>
    ...
    <style>
        /* Mismos estilos que las vistas anteriores */
        :root {
            --color-fondo: #F5F0E8;
            --color-cajas: #FDFBF7;
            --color-bordes: #D4A574;
...
<div class="container-main">
    ...
    <div class="content-section">
        <div class="content-header">
            <h2>
                <i class="fas fa-book" style="color: var(--color-botones);"></i>
                Listado de Materias
                <span class="badge-count">{{ $materias->count() }}</span>
            </h2>
            <a href="/materias/crear" class="btn-add">
                <i class="fas fa-plus-circle"></i> Añadir Nueva Materia
            </a>
        </div>
            ...
            <table class="table-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><i class="fas fa-book" style="color: var(--color-bordes);"></i> {{ $materia->nombre }}</td>
                        <td><span class="badge-credits"><i class="fas fa-star"></i> {{ $materia->creditos }} créditos</span></td>
                        <td>
                            <div class="actions">
                                <a href="/materias/editar/{{ $materia->id }}" class="btn-edit">
                                    <i class="fas fa-edit"></i> Editar
                                </a>
                                <a href="/materias/eliminar/{{ $materia->id }}" class="btn-delete" onclick="return confirm('¿Seguro que deseas eliminar esta materia?')">
        ...
        <div class="text-center py-5" style="color: var(--color-texto); opacity: 0.6;">
            ...
            <a href="/materias/crear" class="btn-add" style="display: inline-flex; margin-top: 10px;">
                <i class="fas fa-plus-circle"></i> Registrar la primera
            </a>
        </div>
        @endif
    </div>
